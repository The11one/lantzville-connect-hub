            ...
            <div className="hidden lg:flex items-center flex-1 ml-8">
              <nav className="flex items-center justify-center w-full">
                <div className="flex items-center space-x-6">
                  ...
                  {/* Search Bar - Inline with Navigation */}
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="pl-10 pr-4 py-2.5 w-64 text-sm border border-input rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary bg-background transition-all duration-200"
                    />
                  </div>

                  {/* Navigation Links - All Visible in Single Row */}
                  {navigation.map((item) => (
                    <Link
                      key={item.name}
                      to={item.href}
                      className={`text-sm font-medium transition-all duration-200 px-4 py-2.5 rounded-md hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 ${
                        isActive(item.href)
